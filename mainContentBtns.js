...
function transferenciaHistoryLog (alias, monto, fecha, movimiento){
  ...
  if(movimiento=="Transferencia"){montoData.classList.add("monto-transferencia")};
...
function updateHistory (){
  transferencias.forEach(element=>
    transferenciaHistoryLog(element.alias, element.monto, element.fecha, element.movimiento)
  )
  transferencias = [];
  document.querySelector("#historialVacioMsg").setAttribute("style", "display:none;")
};
