...
def main():
    ...
    for cheque in cheques:
        ...
        if (
            ...
            cheque["Tipo de Cheque"] == args.tipo_cheque and
    ...
    if args.salida == "PANTALLA":
        for cheque in cheques_filtrados:
            print(f"NroCheque | CodigoBanco | CodigoScurusal | NumeroCuentaOrigen | "
                  f"NumeroCuentaDestino | Valor | FechaOrigen | FechaPago | DNI | Estado")
        ...
        try:
            with open(nombre_archivo, mode='w', newline='') as csvfile:
                fieldnames = ["NroCheque", "CodigoBanco", "CodigoScurusal", "NumeroCuentaOrigen", "NumeroCuentaDestino", "Valor", "FechaOrigen", "FechaPago", "DNI", "Estado"]
